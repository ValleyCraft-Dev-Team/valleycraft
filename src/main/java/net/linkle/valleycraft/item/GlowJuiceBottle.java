...
public class GlowJuiceBottle extends FoodItem {

    public GlowJuiceBottle(Settings settings, int hunger, float satMod, StatusEffect effect) {
    ...
    public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
        ...
        tooltip.add( new TranslatableText("item.valleycraft.dishes.tooltip_8").formatted(Formatting.GRAY) );
    }
}
