...
public class AmethystleFoodItem extends Item {

    public AmethystleFoodItem(Settings settings) {
        super(settings);
    }

    /** @param satMod = saturationModifier */
    public AmethystleFoodItem(Settings settings, int hunger, float satMod) {
        this(settings, hunger, satMod, false);
    }

    /** @param satMod = saturationModifier */
    public AmethystleFoodItem(Settings settings, int hunger, float satMod, boolean isMeat) {
        this(settings, hunger, satMod, isMeat, null);
    }

    /** @param satMod = saturationModifier */
    public AmethystleFoodItem(Settings settings, int hunger, float satMod, @Nullable FoodStatusEffect effects) {
        this(settings, hunger, satMod, false, effects);
    }

    /** @param satMod = saturationModifier */
    public AmethystleFoodItem(Settings settings, int hunger, float satMod, boolean isMeat, @Nullable FoodStatusEffect effects) {
    ...
    public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
        ...
        tooltip.add( new TranslatableText("item.valleycraft.dishes.tooltip_10").formatted(Formatting.GRAY) );
    }
}
