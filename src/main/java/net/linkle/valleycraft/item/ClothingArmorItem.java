...
public class ClothingArmorItem extends ArmorItem implements IAnimatable {
    private final AnimationFactory factory = new AnimationFactory(this);

    public ClothingArmorItem(ArmorMaterial material, EquipmentSlot slot, Settings settings) {
