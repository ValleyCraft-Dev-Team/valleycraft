...
public class ModPotions {
    ...
    public static void initialize() {
        registerRecipe(Potions.WATER, FoodIngredients.INFECTED_MONSTER_HEART.item, ModPotions.ROT_BLIGHT_POTION);

        registerRecipe(Potions.AWKWARD, Items.SCUTE, Potions.TURTLE_MASTER);

        registerRecipe(Potions.AWKWARD, FoodIngredients.RAW_BAT_WING.item, ModPotions.LEVITATION_POTION);
        ...
        registerRecipe(Potions.AWKWARD, BlocksNatural.CLAM_BLOCK.item, ModPotions.ABSORPTION_POTION);
        ...
        registerRecipe(Potions.AWKWARD, Items.NAUTILUS_SHELL, Potions.LUCK);
        registerRecipe(Potions.LUCK, Items.GLOWSTONE_DUST, ModPotions.LUCK_LONG);
        registerRecipe(Potions.LUCK, Items.REDSTONE, ModPotions.LUCK_FAST);

        registerRecipe(Potions.AWKWARD, Items.AMETHYST_SHARD, ModPotions.HASTE_POTION);
        ...
        registerRecipe(Potions.AWKWARD, ItemsModded.MONSTER_CLAW.item, ModPotions.FERAL_STRENGTH);
        registerRecipe(ModPotions.FERAL_STRENGTH, Items.GLOWSTONE_DUST, ModPotions.FERAL_STRENGTH_LONG);

        registerRecipe(Potions.AWKWARD, ItemsModded.SLIME_BLOB.item, Potions.LEAPING);
        registerRecipe(Potions.AWKWARD, FoodRegular.CRYSTALLIZED_HONEYDROP.item, Potions.REGENERATION);

        registerRecipe(Potions.AWKWARD, ItemsModded.DRAGON_TOOTH.item, ModPotions.DRAGONHEARTED);
    }
    ...
    private static void registerRecipe(Potion input, Item item, Potion output) {
        BrewingRecipeRegistryWidener.invokeRegisterPotionRecipe(Potions.AWKWARD, FoodIngredients.INFECTED_MONSTER_HEART.item, ModPotions.ROT_BLIGHT_POTION);

        BrewingRecipeRegistryWidener.invokeRegisterPotionRecipe(Potions.AWKWARD, Items.SCUTE, Potions.TURTLE_MASTER);

        BrewingRecipeRegistryWidener.invokeRegisterPotionRecipe(Potions.AWKWARD, FoodIngredients.RAW_BAT_WING.item, LEVITATION_POTION);
        ...
        BrewingRecipeRegistryWidener.invokeRegisterPotionRecipe(Potions.AWKWARD, BlocksNatural.CLAM_BLOCK.item, ABSORPTION_POTION);
        ...
        BrewingRecipeRegistryWidener.invokeRegisterPotionRecipe(Potions.AWKWARD, Items.NAUTILUS_SHELL, Potions.LUCK);
        BrewingRecipeRegistryWidener.invokeRegisterPotionRecipe(Potions.LUCK, Items.GLOWSTONE_DUST, ModPotions.LUCK_LONG);
        BrewingRecipeRegistryWidener.invokeRegisterPotionRecipe(Potions.LUCK, Items.REDSTONE, ModPotions.LUCK_FAST);

        BrewingRecipeRegistryWidener.invokeRegisterPotionRecipe(Potions.AWKWARD, Items.AMETHYST_SHARD, ModPotions.HASTE_POTION);
        ...
        BrewingRecipeRegistryWidener.invokeRegisterPotionRecipe(Potions.AWKWARD, Items.GOAT_HORN, Potions.STRENGTH);

        BrewingRecipeRegistryWidener.invokeRegisterPotionRecipe(Potions.AWKWARD, ItemsModded.MONSTER_CLAW.item, ModPotions.FERAL_STRENGTH);
        ...
        BrewingRecipeRegistryWidener.invokeRegisterPotionRecipe(Potions.AWKWARD, ItemsModded.SLIME_BLOB.item, Potions.LEAPING);
        BrewingRecipeRegistryWidener.invokeRegisterPotionRecipe(Potions.AWKWARD, FoodRegular.CRYSTALLIZED_HONEYDROP.item, Potions.REGENERATION);

        BrewingRecipeRegistryWidener.invokeRegisterPotionRecipe(Potions.AWKWARD, ItemsModded.DRAGON_TOOTH.item, ModPotions.DRAGONHEARTED);
    }
}
