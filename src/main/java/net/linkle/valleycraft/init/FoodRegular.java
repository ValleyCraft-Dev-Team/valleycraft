...
public enum FoodRegular implements ItemEnum {
    ...
    CHOCOLATE(new FastFoodItem(settings(), 2, 0.3f)),
    ...
    CHOCOLATE_PUMPKIN_SPICE_COOKIE(new FastFoodItem(settings().maxCount(16), 2, 0.2f)),
    PUMPKIN_PIE_SLICE(new FastFoodItem(settings().maxCount(16), 2, 0.5f)),
    APPLE_PIE(new FoodItem(settings(), 8, 0.4f)),
    APPLE_PIE_SLICE(new FastFoodItem(settings().maxCount(16), 2, 0.5f)),
    SWEET_BERRY_PIE(new FoodItem(settings(), 8, 0.4f)),
    SWEET_BERRY_PIE_SLICE(new FastFoodItem(settings().maxCount(16), 2, 0.5f)),
    GLOW_BERRY_PIE(new FoodItem(settings(), 8, 0.4f)),
    GLOW_BERRY_PIE_SLICE(new FastFoodItem(settings().maxCount(16), 2, 0.5f)),
    ...
    APPLE_JUICE(new BottleItem(settings().recipeRemainder(net.minecraft.item.Items.GLASS_BOTTLE).maxCount(16), 4, 0.3f)),
    ...
    GOLDEN_CAVE_ROOT(new FoodItem(settings(), 6, 2.4f)),
    GOLDEN_CHORUS_FRUIT(new FoodItem(settings().rarity(Rarity.RARE), 6, 2.4f)),
    GOLDEN_ENDURA_CARROT(new FoodItem(settings().rarity(Rarity.RARE), 6, 2.4f)),
    GOLDEN_BEETROOT(new FoodItem(settings(), 6, 2.4f)),
    GOLDEN_HEARTY_BEETROOT(new FoodItem(settings().rarity(Rarity.RARE), 6, 2.4f)),
    GOLDEN_FIRE_PEPPER(new FoodItem(settings(), 6, 2.4f)),
    GOLDEN_SWEET_BERRIES(new FoodItem(settings(), 6, 2.4f)),
    GOLDEN_GLOW_BERRIES(new FoodItem(settings(), 6, 2.4f)),
