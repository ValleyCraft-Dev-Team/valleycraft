...
public enum FoodRegular implements ItemEnum {
    ...
    COOKED_SILVERFISH(new FoodItem(settings(), 3, Nourishment.NORMAL)),
    COOKED_PHANTOM(new FoodItem(settings(), 6, Nourishment.NORMAL)),
    COOKED_BIRD(new FastFoodItem(settings(), 3, Nourishment.NORMAL)),
    COOKED_BACON(new FastFoodItem(settings(), 3, Nourishment.NORMAL)),
    COOKED_BAT(new FastFoodItem(settings(), 3, Nourishment.NORMAL, true)),
    FRIED_EGG(new FoodItem(settings(), 4, Nourishment.NORMAL)),
    ...
    CHOCOLATE_MILK(new BottleItem(settings().recipeRemainder(net.minecraft.item.Items.GLASS_BOTTLE).maxCount(16), 2, Nourishment.POOR).setMilk()),
    ATOLE_MILK(new BottleItem(settings().recipeRemainder(net.minecraft.item.Items.GLASS_BOTTLE).maxCount(16), 2, Nourishment.POOR).setMilk()),
    EGGNOG(new BottleItem(settings().recipeRemainder(net.minecraft.item.Items.GLASS_BOTTLE).maxCount(16), 4, Nourishment.LOW).setMilk()),
    APPLE_JUICE(new BottleItem(settings().recipeRemainder(net.minecraft.item.Items.GLASS_BOTTLE).maxCount(16), 4, Nourishment.LOW)),
    CARROT_JUICE(new BottleItem(settings().recipeRemainder(net.minecraft.item.Items.GLASS_BOTTLE).maxCount(16), 4, Nourishment.LOW)),
    SWEET_BERRY_JUICE(new BottleItem(settings().recipeRemainder(net.minecraft.item.Items.GLASS_BOTTLE).maxCount(16), 4, Nourishment.LOW)),
    CHORUS_FRUIT_JUICE(new BottleItem(settings().recipeRemainder(net.minecraft.item.Items.GLASS_BOTTLE).maxCount(16), 4, Nourishment.LOW)),
    ALOE_VERA_JUICE(new Tier0Bottle(settings().recipeRemainder(net.minecraft.item.Items.GLASS_BOTTLE).maxCount(16), 4, Nourishment.LOW, StatusEffects.REGENERATION)),
