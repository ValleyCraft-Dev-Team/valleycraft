...
public class MemoryBoxEntity extends ContainerBlockEntity {

    public MemoryBoxEntity(BlockPos pos, BlockState state) {
        super(BlockEntities.MEMORYBOX.type(), pos, state);
    }

    @Override
    protected Text getContainerName() {
        return Text.translatable("container.valleycraft.memorybox");
    }
