 ...
 */
public class CavePaintingFamily extends HorizontalFacingBlock {

    public CavePaintingFamily(Settings settings) {
        super(settings);
        setDefaultState();
    }
    ...
    public void appendTooltip(ItemStack itemStack, BlockView world, List<Text> tooltip, TooltipContext tooltipContext) {
        tooltip.add( Text.translatable("item.valley.cave_painting.tooltip.family").formatted(Formatting.GRAY));
    }
}
