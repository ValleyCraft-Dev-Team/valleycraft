 ...
 */
public class CavePaintingZombie extends HorizontalFacingBlock {

    public CavePaintingZombie(Settings settings) {
        super(settings);
        setDefaultState();
    }
    ...
    public void appendTooltip(ItemStack itemStack, BlockView world, List<Text> tooltip, TooltipContext tooltipContext) {
        tooltip.add( Text.translatable("item.valley.cave_painting.tooltip.zombie").formatted(Formatting.GRAY));
    }
}
