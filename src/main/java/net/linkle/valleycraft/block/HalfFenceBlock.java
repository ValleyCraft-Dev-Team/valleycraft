...
public class HalfFenceBlock extends HorizontalConnectingBlock {
    private final VoxelShape[] cullingShapes;

    public HalfFenceBlock(Settings settings) {
        super(2.0F, 2.0F, 6.0F, 6.0F, 16.0F, settings);
        ...
        this.cullingShapes = this.createShapes(2.0F, 1.0F, 6.0F, 6.0F, 5.0F);
    }
