...
public enum ArmorMats implements ArmorMaterial {
    ...
    ALEX("ruined_alex_zombie", ints(2), 10, 15, equipLeather(), items(net.minecraft.item.Items.LEATHER)),
    EFE("ruined_efe_zombie", ints(2), 10, 15, equipLeather(), items(net.minecraft.item.Items.LEATHER)),
    ...
    BIKINI_COAT("wretch", ints(1,2), 10, 15, equipLeather(), items(net.minecraft.item.Items.LEATHER)),
    ...
    BRUTE("brute", ints(3), 10, 15, equipLeather(), items(net.minecraft.item.Items.LEATHER)),
    ...
    EYEPATCH("eyepatch", ints(1), 10, 15, equipLeather(), items(net.minecraft.item.Items.LEATHER)),
    HEADSCARF("seaologer_headscarf", ints(1), 10, 15, equipLeather(), items(ItemsModded.CLOTH)),
    FUR("fur_boots", ints(2,3), 10, 15, equipLeather(), items(net.minecraft.item.Items.LEATHER)),
    ...
    LEGGINGS("leggings", ints(1,2,2,2), 30, 15, equipLeather(), items(net.minecraft.item.Items.LEATHER)),
    ...
    WHITE_FEATHER("white_feather", ints(1,5,6,1), 10, 15, equipLeather(), items(net.minecraft.item.Items.FEATHER)),
    CROW_FEATHER("crow_feather", ints(1,5,6,1), 10, 15, equipLeather(), items(ItemsModded.CROWS_FEATHER)),
    SEAGULL_FEATHER("seagull_feather", ints(1,5,6,1), 10, 15, equipLeather(), items(ItemsModded.SEAGULLS_FEATHER)),
    DUCK_FEATHER("duck_feather", ints(1,5,6,1), 10, 15, equipLeather(), items(ItemsModded.DUCKS_FEATHER)),

    CIRCLET_GOLD("golden_circlet", ints(0,0,0,2), 15, 25, equipChain(), items(net.minecraft.item.Items.GOLD_INGOT)),
    CIRCLET_IRON("iron_circlet", ints(0,0,0,1), 15, 9, equipChain(), items(net.minecraft.item.Items.IRON_INGOT)),
    CIRCLET_DIAMOND("diamond_circlet", ints(0,0,0,2), 15, 9, equipChain(), items(net.minecraft.item.Items.DIAMOND)),
    ...
    TREE_GOD("tree_god_mask", ints(2,2,2,2), 10, 25, equipLeather(), items(net.minecraft.item.Items.OAK_LOG)),

    RIBCAGE("ribcage", ints(6), 10, 22, equipLeather(), items(net.minecraft.item.Items.BONE), 1.0f, 0.0f),
    WITHER_RIBCAGE("wither_ribcage", ints(7), 10, 22, equipLeather(), items(net.minecraft.item.Items.BONE), 1.0f, 0.0f),
    ...
    AMETHYST_GOGGLES("amethyst_goggles", ints(2,2,2,2), 10, 15, equipChain(), items(AMETHYST_SHARD)),
    NIGHTVISION_GOGGLES("nightvision_goggles", ints(2,2,2,2), 10, 15, equipChain(), items(ECHO_SHARD)),
    PIGLIN("piglin", ints(2), 10, 15, equipLeather(), items(net.minecraft.item.Items.LEATHER)),
    PILLAGER("pillager", ints(3), 10, 15, equipLeather(), items(net.minecraft.item.Items.LEATHER)),
    STEVE("ruined_steve_zombie", ints(2), 10, 15, equipLeather(), items(net.minecraft.item.Items.LEATHER)),
    STRAW_HAT("straw_hat", ints(2,5,6,2), 10, 15, equipLeather(), items(net.minecraft.item.Items.WHEAT)),
    ...
    BUTTON("button", ints(0,0,7,2), 10, 15, equipChain(), items(net.minecraft.item.Items.STRING)),
    ...
    RF_LEATHER("reinforced_leather", ints(1,1,2,2), 15, 25, equipChain(), items(net.minecraft.item.Items.GOLD_INGOT)),
    RF_GOLD("reinforced_gold", ints(1,1,4,3), 15, 25, equipChain(), items(net.minecraft.item.Items.GOLD_INGOT)),
    RF_IRON("reinforced_iron", ints(2,3,5,3), 15, 25, equipChain(), items(net.minecraft.item.Items.GOLD_INGOT)),
    ...
    HAUBERK_IRON("iron_hauberk", ints(2,5,5,3), 15, 25, equipChain(), items(net.minecraft.item.Items.GOLD_INGOT)),
