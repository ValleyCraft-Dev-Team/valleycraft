...
import net.linkle.valleycraft.client.entity.model.SardineEntityModel;
...
public class SardineEntityRenderer extends MobEntityRenderer<FishEntity, SardineEntityModel<FishEntity>> {

    private final Identifier texture;

    private SardineEntityRenderer(EntityRendererFactory.Context context, Identifier texture) {
        super(context, new SardineEntityModel<FishEntity>(context.getPart(SardineEntityModel.LAYER)), 0.3f);
    ...
    public static EntityRendererFactory<FishEntity> create(String texture) {
        ...
        return context -> new SardineEntityRenderer(context, id);
    }
}
