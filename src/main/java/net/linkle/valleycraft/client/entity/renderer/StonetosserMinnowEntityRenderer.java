...
import net.linkle.valleycraft.client.entity.model.StonetosserMinnowEntityModel;
...
public class StonetosserMinnowEntityRenderer extends MobEntityRenderer<FishEntity, StonetosserMinnowEntityModel<FishEntity>> {

    private final Identifier texture;

    private StonetosserMinnowEntityRenderer(EntityRendererFactory.Context context, Identifier texture) {
        super(context, new StonetosserMinnowEntityModel<FishEntity>(context.getPart(StonetosserMinnowEntityModel.LAYER)), 0.3f);
    ...
    public static EntityRendererFactory<FishEntity> create(String texture) {
        ...
        return context -> new StonetosserMinnowEntityRenderer(context, id);
    }
}
