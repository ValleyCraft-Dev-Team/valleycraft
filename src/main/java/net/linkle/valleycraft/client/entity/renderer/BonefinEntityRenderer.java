...
import net.linkle.valleycraft.client.entity.model.BonefinEntityModel;
...
public class BonefinEntityRenderer extends MobEntityRenderer<FishEntity, BonefinEntityModel<FishEntity>> {

    private final Identifier texture;

    private BonefinEntityRenderer(EntityRendererFactory.Context context, Identifier texture) {
        super(context, new BonefinEntityModel<FishEntity>(context.getPart(BonefinEntityModel.LAYER)), 0.3f);
    ...
    public static EntityRendererFactory<FishEntity> create(String texture) {
        ...
        return context -> new BonefinEntityRenderer(context, id);
    }
}
