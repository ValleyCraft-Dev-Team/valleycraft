...
public class CaveSnailEntityModel<T extends MobEntity> extends SinglePartEntityModel<T> {

    public static final EntityModelLayer LAYER = new EntityModelLayer(Main.makeId("cave_snail"), "main");

	private final ModelPart main;

	public CaveSnailEntityModel(ModelPart root) {
