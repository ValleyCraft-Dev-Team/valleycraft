...
public class RedPorgyRenderer extends MobEntityRenderer<FishEntity, RedPorgyEntityModel<FishEntity>> {

    private final Identifier texture;

    private RedPorgyRenderer(EntityRendererFactory.Context context, Identifier texture) {
        super(context, new RedPorgyEntityModel<FishEntity>(context.getPart(RedPorgyEntityModel.LAYER)), 0.3f);
    ...
    public static EntityRendererFactory<FishEntity> create(String texture) {
        ...
        return context -> new RedPorgyRenderer(context, id);
    }
}
