...
import net.linkle.valleycraft.client.entity.model.AbysswatcherEntityModel;
...
public class AbysswatcherEntityRenderer extends MobEntityRenderer<FishEntity, AbysswatcherEntityModel<FishEntity>> {

    private final Identifier texture;

    private AbysswatcherEntityRenderer(EntityRendererFactory.Context context, Identifier texture) {
        super(context, new AbysswatcherEntityModel<FishEntity>(context.getPart(AbysswatcherEntityModel.LAYER)), 0.3f);
    ...
    public static EntityRendererFactory<FishEntity> create(String texture) {
        ...
        return context -> new AbysswatcherEntityRenderer(context, id);
    }
}
